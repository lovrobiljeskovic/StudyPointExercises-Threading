...
// The difference is that start() method creates a new thread which executes the run method, whereas run() executes on the same caller method

//Time Parallel:  1729239918
//Time Sequential:3877639594	
